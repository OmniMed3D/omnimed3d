...
- **Currently implemented UI shell:** local file/folder picker, mouse-driven orbit camera (rotate + wheel zoom), window/level sliders plus 4 clinical presets (issue #34); a 3D-orbit/2D-axial-slice view-mode toggle and slice slider (issue #37) completing PRD §9's rotate/zoom/slice-pan success criterion.
